...
# Phony targets
.PHONY: all clean copy-index release prune-build test-fixtures test
...
test-fixtures:
	...
	python3 /home/runner/work/polished-save-patcher/polished-save-patcher/tests/verify_fixtures.py
