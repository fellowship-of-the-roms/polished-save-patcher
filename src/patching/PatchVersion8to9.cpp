...
namespace patchVersion8to9Namespace {
	...
	uint16_t mapV8EventFlagToV9(uint16_t v8) {
		std::unordered_map<uint16_t, uint16_t> indexMap = {
				...
				{2017, 2015},  // EVENT_MURKY_SWAMP_CHERYL
				{2018, 2016},  // EVENT_DIM_CAVE_RILEY
				{2019, 2017},  // EVENT_CINNABAR_VOLCANO_BUCK
				{2020, 2018},  // EVENT_QUIET_CAVE_MARLEY
				{2021, 2019},  // EVENT_SCARY_CAVE_MIRA
				{2022, 2020},  // EVENT_BATTLE_TOWER_OUTSIDE_ANABEL
				{2023, 2021},  // EVENT_BATTLE_TOWER_CHERYL
				{2024, 2022},  // EVENT_BATTLE_TOWER_RILEY
				{2025, 2023},  // EVENT_BATTLE_TOWER_BUCK
				{2026, 2024},  // EVENT_BATTLE_TOWER_MARLEY
				{2027, 2025},  // EVENT_BATTLE_TOWER_MIRA
				{2028, 2026},  // EVENT_BATTLE_TOWER_ANABEL
				{2029, 2027},  // EVENT_BEAUTIFUL_BEACH_FULL_RESTORE
				{2030, 2028},  // EVENT_BEAUTIFUL_BEACH_LUXURY_BALL
				{2031, 2029},  // EVENT_ROCKY_BEACH_FULL_HEAL
				{2032, 2030},  // EVENT_ROCKY_BEACH_PEARL_STRING
				{2033, 2031},  // EVENT_NOISY_FOREST_BALMMUSHROOM
				{2034, 2032},  // EVENT_NOISY_FOREST_MULCH
				{2035, 2033},  // EVENT_NOISY_FOREST_TM_DRAIN_PUNCH
				{2036, 2034},  // EVENT_SHAMOUTI_SHRINE_RUINS_RARE_CANDY
				{2037, 2035},  // EVENT_SHAMOUTI_TUNNEL_SMOOTH_ROCK
				{2038, 2036},  // EVENT_SHAMOUTI_TUNNEL_X_SPEED
				{2039, 2037},  // EVENT_SHAMOUTI_COAST_STAR_PIECE
				{2040, 2038},  // EVENT_FIRE_ISLAND_HEAT_ROCK
				{2041, 2039},  // EVENT_ICE_ISLAND_ICY_ROCK
				{2042, 2040},  // EVENT_LIGHTNING_ISLAND_DAMP_ROCK
				{2043, 2041},  // EVENT_SHAMOUTI_ISLAND_ALOLAN_EXEGGUTOR
				{2044, 2042},  // EVENT_SHAMOUTI_ISLAND_PIKABLU_GUY
				{2045, 2043},  // EVENT_SHAMOUTI_POKE_CENTER_IVY
				{2046, 2044},  // EVENT_NOISY_FOREST_PIKABLU
				{2050, 2046},  // EVENT_KURTS_HOUSE_GRANDDAUGHTER_1
				{2051, 2047},  // EVENT_KURTS_HOUSE_GRANDDAUGHTER_2
				{2052, 2048},  // EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FISHER
				{2053, 2049},  // EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
				{2054, 2050},  // EVENT_DRAGON_SHRINE_CLAIR
				{2055, 2051},  // EVENT_BATTLE_TOWER_BATTLE_ROOM_YOUNGSTER
				{2056, 2052},  // EVENT_PLAYERS_HOUSE_1F_NEIGHBOR
				{2057, 2053},  // EVENT_PLAYERS_NEIGHBORS_HOUSE_NEIGHBOR
				{2058, 2054},  // EVENT_PICKED_UP_SUN_STONE_FROM_HO_OH_ITEM_ROOM
				{2059, 2055},  // EVENT_PICKED_UP_MOON_STONE_FROM_HO_OH_ITEM_ROOM
				{2060, 2056},  // EVENT_PICKED_UP_LIFE_ORB_FROM_HO_OH_ITEM_ROOM
				{2061, 2057},  // EVENT_PICKED_UP_CHARCOAL_FROM_HO_OH_ITEM_ROOM
				{2062, 2058},  // EVENT_PICKED_UP_SITRUS_BERRY_FROM_KABUTO_ITEM_ROOM
				{2063, 2059},  // EVENT_PICKED_UP_LUM_BERRY_FROM_KABUTO_ITEM_ROOM
				{2064, 2060},  // EVENT_PICKED_UP_HEAL_POWDER_FROM_KABUTO_ITEM_ROOM
				{2065, 2061},  // EVENT_PICKED_UP_ENERGYPOWDER_FROM_KABUTO_ITEM_ROOM
				{2066, 2062},  // EVENT_PICKED_UP_PEARL_STRING_FROM_OMANYTE_ITEM_ROOM
				{2067, 2063},  // EVENT_PICKED_UP_BIG_PEARL_FROM_OMANYTE_ITEM_ROOM
				{2068, 2064},  // EVENT_PICKED_UP_STARDUST_FROM_OMANYTE_ITEM_ROOM
				{2069, 2065},  // EVENT_PICKED_UP_STAR_PIECE_FROM_OMANYTE_ITEM_ROOM
				{2070, 2066},  // EVENT_PICKED_UP_RARE_BONE_FROM_AERODACTYL_ITEM_ROOM
				{2071, 2067},  // EVENT_PICKED_UP_ENERGY_ROOT_FROM_AERODACTYL_ITEM_ROOM
				{2072, 2068},  // EVENT_PICKED_UP_REVIVAL_HERB_FROM_AERODACTYL_ITEM_ROOM
				{2073, 2069},  // EVENT_PICKED_UP_SOOTHE_BELL_FROM_AERODACTYL_ITEM_ROOM
				{2074, 2070},  // EVENT_AZALEA_TOWN_KURT
				{2075, 2071},  // EVENT_ILEX_FOREST_KURT
				{2076, 2072},  // EVENT_MOUNT_MORTAR_1F_INSIDE_MAX_POTION
				{2077, 2073},  // EVENT_MOUNT_MORTAR_1F_INSIDE_NUGGET
				{2078, 2074},  // EVENT_ECRUTEAK_GYM_GRAMPS
				{2079, 2075},  // EVENT_ECRUTEAK_CITY_GRAMPS
				{2080, 2076},  // EVENT_EUSINE_IN_BURNED_TOWER
				{2081, 2077},  // EVENT_WISE_TRIOS_ROOM_WISE_TRIO_1
				{2082, 2078},  // EVENT_WISE_TRIOS_ROOM_WISE_TRIO_2
				{2083, 2079},  // EVENT_CIANWOOD_CITY_EUSINE
				{2084, 2080},  // EVENT_SAW_SUICUNE_AT_CIANWOOD_CITY
				{2085, 2081},  // EVENT_SAW_SUICUNE_ON_ROUTE_42
				{2086, 2082},  // EVENT_SAW_SUICUNE_ON_ROUTE_36
				{2087, 2083},  // EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
				{2088, 2084},  // EVENT_TIN_TOWER_1F_SUICUNE
				{2089, 2085},  // EVENT_TIN_TOWER_1F_ENTEI
				{2090, 2086},  // EVENT_TIN_TOWER_1F_RAIKOU
				{2091, 2087},  // EVENT_TIN_TOWER_1F_EUSINE
				{2092, 2088},  // EVENT_TIN_TOWER_1F_WISE_TRIO_1
				{2093, 2089},  // EVENT_EUSINES_HOUSE_EUSINE
				{2094, 2090},  // EVENT_ROUTE_30_ANTIDOTE
				{2095, 2091},  // EVENT_ILEX_FOREST_X_ATTACK
				{2096, 2092},  // EVENT_ILEX_FOREST_ANTIDOTE
				{2097, 2093},  // EVENT_ILEX_FOREST_MULCH
				{2098, 2094},  // EVENT_ROUTE_34_NUGGET
				{2099, 2095},  // EVENT_ROUTE_44_MAX_REPEL
				{2100, 2096},  // EVENT_ICE_PATH_1F_HEAT_ROCK
				{2101, 2097},  // EVENT_DRAGONS_DEN_B1F_CALCIUM
				{2102, 2098},  // EVENT_DRAGONS_DEN_B1F_MAX_ELIXIR
				{2103, 2099},  // EVENT_SILVER_CAVE_ROOM_1_ULTRA_BALL
				{2104, 2100},  // EVENT_SILVER_CAVE_ROOM_2_CALCIUM
				{2105, 2101},  // EVENT_SILVER_CAVE_ROOM_2_ULTRA_BALL
				{2106, 2102},  // EVENT_SILVER_CAVE_ROOM_2_PP_UP
				{2107, 2103},  // EVENT_TIN_TOWER_1F_WISE_TRIO_2
				{2108, 2104},  // EVENT_TIN_TOWER_6F_MAX_POTION
				{2109, 2105},  // EVENT_TIN_TOWER_9F_HP_UP
				{2110, 2106},  // EVENT_MOUNT_MORTAR_1F_INSIDE_IRON
				{2111, 2107},  // EVENT_MOUNT_MORTAR_1F_INSIDE_ULTRA_BALL
				{2112, 2108},  // EVENT_MOUNT_MORTAR_B1F_PROTECTOR
				{2113, 2109},  // EVENT_MOUNT_MORTAR_B1F_MAX_ETHER
				{2114, 2110},  // EVENT_MOUNT_MORTAR_B1F_PP_UP
				{2115, 2111},  // EVENT_RADIO_TOWER_5F_ZOOM_LENS
				{2116, 2112},  // EVENT_DARK_CAVE_VIOLET_ENTRANCE_DIRE_HIT
				{2117, 2113},  // EVENT_BEAT_ELITE_FOUR_AGAIN
				{2118, 2114},  // EVENT_REMATCH_GYM_LEADER_1
				{2119, 2115},  // EVENT_REMATCH_GYM_LEADER_2
				{2120, 2116},  // EVENT_REMATCH_GYM_LEADER_3
				{2121, 2117},  // EVENT_REMATCH_GYM_LEADER_4
				{2122, 2118},  // EVENT_REMATCH_GYM_LEADER_5
				{2123, 2119},  // EVENT_REMATCH_GYM_LEADER_6
				{2124, 2120},  // EVENT_COPYCAT_3
				{2125, 2121},  // EVENT_CINNABAR_LAB_CRYS
				{2126, 2122},  // EVENT_DO_RUINS_OF_ALPH_CLIMAX
				{2127, 2123},  // EVENT_RUINS_OF_ALPH_CLIMAX_DONE
				{2128, 2124},  // EVENT_MAGNET_TUNNEL_LODESTONE_IN_PIT
				{2129, 2125},  // EVENT_YELLOW_FOREST_ROCKET_TAKEOVER
				{2130, 2126},  // EVENT_CLEARED_YELLOW_FOREST
				{2131, 2127},  // EVENT_GOT_LIGHT_BALL_FROM_YELLOW
				{2132, 2128},  // EVENT_INTRODUCED_LORELEI
				{2133, 2129},  // EVENT_INTRODUCED_FLANNERY
				{2134, 2130},  // EVENT_INTRODUCED_MARLON
				{2135, 2131},  // EVENT_INTRODUCED_KUKUI
				{2136, 2132},  // EVENT_LISTENED_TO_STEVEN_INTRO
				{2137, 2133},  // EVENT_GOT_MUSCLE_BAND_FROM_STEVEN
				{2138, 2134},  // EVENT_LISTENED_TO_CYNTHIA_INTRO
				{2139, 2135},  // EVENT_GOT_WISE_GLASSES_FROM_CYNTHIA
				{2140, 2136},  // EVENT_SPOKE_TO_LADY_JESSICA
				{2141, 2137},  // EVENT_GOT_SILPHSCOPE2_FROM_MR_FUJI
				{2142, 2138},  // EVENT_EXORCISED_LAV_RADIO_TOWER
				{2143, 2139},  // EVENT_GOT_EXPERT_BELT
				{2144, 2140},  // EVENT_ROUTE_2_CUT_TREE_1
				{2145, 2141},  // EVENT_ROUTE_2_CUT_TREE_2
				{2146, 2142},  // EVENT_ROUTE_2_CUT_TREE_3
				{2147, 2143},  // EVENT_ROUTE_2_CUT_TREE_4
				{2148, 2144},  // EVENT_ROUTE_2_CUT_TREE_5
				{2149, 2145},  // EVENT_ROUTE_8_CUT_TREE_1
				{2150, 2146},  // EVENT_ROUTE_8_CUT_TREE_2
				{2151, 2147},  // EVENT_ROUTE_9_CUT_TREE
				{2152, 2148},  // EVENT_ROUTE_10_CUT_TREE_1
				{2153, 2149},  // EVENT_ROUTE_10_CUT_TREE_2
				{2154, 2150},  // EVENT_ROUTE_10_CUT_TREE_3
				{2155, 2151},  // EVENT_ROUTE_10_CUT_TREE_4
				{2156, 2152},  // EVENT_ROUTE_12_CUT_TREE_1
				{2157, 2153},  // EVENT_ROUTE_12_CUT_TREE_2
				{2158, 2154},  // EVENT_ROUTE_13_CUT_TREE
				{2159, 2155},  // EVENT_ROUTE_14_CUT_TREE_1
				{2160, 2156},  // EVENT_ROUTE_14_CUT_TREE_2
				{2161, 2157},  // EVENT_ROUTE_14_CUT_TREE_3
				{2162, 2158},  // EVENT_ROUTE_16_CUT_TREE
				{2163, 2159},  // EVENT_ROUTE_16_WEST_CUT_TREE_1
				{2164, 2160},  // EVENT_ROUTE_16_WEST_CUT_TREE_2
				{2165, 2161},  // EVENT_ROUTE_25_CUT_TREE
				{2166, 2162},  // EVENT_ROUTE_29_CUT_TREE_1
				{2167, 2163},  // EVENT_ROUTE_29_CUT_TREE_2
				{2168, 2164},  // EVENT_ROUTE_30_CUT_TREE
				{2169, 2165},  // EVENT_ROUTE_31_CUT_TREE_1
				{2170, 2166},  // EVENT_ROUTE_31_CUT_TREE_2
				{2171, 2167},  // EVENT_ROUTE_32_CUT_TREE
				{2172, 2168},  // EVENT_ROUTE_35_CUT_TREE
				{2173, 2169},  // EVENT_ROUTE_42_CUT_TREE
				{2174, 2170},  // EVENT_ROUTE_43_CUT_TREE
				{2175, 2171},  // EVENT_CELADON_CITY_CUT_TREE
				{2176, 2172},  // EVENT_FUCHSIA_CITY_CUT_TREE
				{2177, 2173},  // EVENT_VERMILION_CITY_CUT_TREE
				{2178, 2174},  // EVENT_VIOLET_CITY_CUT_TREE
				{2179, 2175},  // EVENT_VIRIDIAN_CITY_CUT_TREE_1
				{2180, 2176},  // EVENT_VIRIDIAN_CITY_CUT_TREE_2
				{2181, 2177},  // EVENT_ILEX_FOREST_CUT_TREE
				{2182, 2178},  // EVENT_LAKE_OF_RAGE_CUT_TREE_1
				{2183, 2179},  // EVENT_LAKE_OF_RAGE_CUT_TREE_2
				{2184, 2180},  // EVENT_LAKE_OF_RAGE_CUT_TREE_3
				{2185, 2181},  // EVENT_LAKE_OF_RAGE_CUT_TREE_4
				{2186, 2182},  // EVENT_LAKE_OF_RAGE_CUT_TREE_5
				{2187, 2183},  // EVENT_SILVER_CAVE_OUTSIDE_CUT_TREE_1
				{2188, 2184},  // EVENT_SILVER_CAVE_OUTSIDE_CUT_TREE_2
				{2189, 2185},  // EVENT_MURKY_SWAMP_CUT_TREE_1
				{2190, 2186},  // EVENT_MURKY_SWAMP_CUT_TREE_2
				{2191, 2187},  // EVENT_NOISY_FOREST_CUT_TREE_1
				{2192, 2188},  // EVENT_NOISY_FOREST_CUT_TREE_2
				{2193, 2189},  // EVENT_ROUTE_49_CUT_TREE_1
				{2194, 2190},  // EVENT_ROUTE_49_CUT_TREE_2
				{2195, 2191},  // EVENT_MAGNET_TUNNEL_EAST_CUT_TREE
				{2196, 2192},  // EVENT_CHERRYGROVE_BAY_CUT_TREE
				{2197, 2193},  // EVENT_MAGNET_TUNNEL_HIDDEN_METAL_POWDER
				{2198, 2194},  // EVENT_BEAT_ENGINEER_GRADEN
				{2199, 2195},  // EVENT_BEAT_ENGINEER_GUSTAV
				{2200, 2196},  // EVENT_BEAT_ENGINEER_NICOLAS
				{2201, 2197},  // EVENT_MAGNET_TUNNEL_TM_GYRO_BALL
				{2203, 2199},  // EVENT_GOT_CLEAR_AMULET_IN_AZALEA
				{2204, 2200},  // EVENT_GOT_ROOM_SERVICE_IN_CELADON_HOTEL
				{2205, 2201},  // EVENT_WAREHOUSE_ENTRANCE_HIDDEN_X_SP_ATK
				{2206, 2202},  // EVENT_INTRODUCED_PIERS
				{2207, 2203},  // EVENT_GOT_THROAT_SPRAY_FROM_PIERS
				{2208, 2204},  // EVENT_LISTENED_TO_ENDURE_INTRO
				{2209, 2205},  // EVENT_BEAT_KIMONO_GIRL_MAKO
				{2210, 2206},  // EVENT_BEAT_KIMONO_GIRL_AMI
				{2211, 2207},  // EVENT_BEAT_KIMONO_GIRL_MINA
				{2212, 2208},  // EVENT_GOT_RARE_CANDY_FROM_KIMONO_GIRL_MAKO
				{2213, 2209},  // EVENT_GOT_PP_MAX_FROM_KIMONO_GIRL_AMI
				{2214, 2210},  // EVENT_GOT_ABILITYPATCH_FROM_KIMONO_GIRL_MINA
				{2215, 2211},  // EVENT_OLIVINE_PORT_GO_GOGGLES
				{2216, 2212},  // EVENT_BEAT_NURSE_BEATRICE
				{2217, 2213},  // EVENT_BEAT_NURSE_KEIKO
				{2218, 2214},  // EVENT_RUGGED_ROAD_SOUTH_IRON_BALL
				{2219, 2215},  // EVENT_RUGGED_ROAD_SOUTH_REVIVE
				{2220, 2216},  // EVENT_RUGGED_ROAD_SOUTH_HIDDEN_IRON
				{2221, 2217},  // EVENT_RUGGED_ROAD_NORTH_X_ATTACK
				{2222, 2218},  // EVENT_RUGGED_ROAD_NORTH_HYPER_POTION
				{2223, 2219},  // EVENT_RUGGED_ROAD_NORTH_HIDDEN_RARE_BONE
				{2224, 2220},  // EVENT_SNOWTOP_MOUNTAIN_INSIDE_ETHER
				{2225, 2221},  // EVENT_SNOWTOP_MOUNTAIN_INSIDE_HEAVY_BOOTS
				{2226, 2222},  // EVENT_SNOWTOP_MOUNTAIN_INSIDE_COVERT_CLOAK
				{2227, 2223},  // EVENT_SNOWTOP_MOUNTAIN_INSIDE_HIDDEN_ZINC
				{2228, 2224},  // EVENT_INTRODUCED_KATY
				{2229, 2225},  // EVENT_BEAT_KATY
				{2230, 2226},  // EVENT_GOT_SWEET_HONEY_FROM_KATY
				{2231, 2227},  // EVENT_BEAT_THORTON
				{2232, 2228},  // EVENT_UNION_CAVE_B2F_LINKING_CORD
				{2233, 2229},  // EVENT_GOT_LOADED_DICE_FROM_GOLDENROD
				{2234, 2230},  // EVENT_LISTENED_TO_BATON_PASS_INTRO
				{2235, 2231},  // EVENT_CAUGHT_HISUIAN_TYPHLOSION
				{2236, 2232},  // EVENT_TALKED_TO_VIOLET_CEMETERY_CARETAKER
				{2237, 2233},  // EVENT_VIOLET_CEMETERY_CARETAKER
		};
