...
namespace patchVersion7to8Namespace {
	...
	constexpr uint16_t SUICUNE_V8 = 0xf5;
	constexpr uint16_t ARTICUNO_V8 = 0x90;
	constexpr uint16_t ZAPDOS_V8 = 0x91;
	constexpr uint16_t MOLTRES_V8 = 0x92;
	constexpr uint16_t MEW_V8 = 0x97;
	constexpr uint16_t MEWTWO_V8 = 0x96;
	constexpr uint16_t CELEBI_V8 = 0xfb;
