...
namespace {
	...
	constexpr int NUM_UNIQUE_POKEMON_V8 = 0x188;
	...
	uint16_t HO_OH_V8 = 0xfa;
	uint16_t LUGIA_V8 = 0xf9;
	uint16_t RAIKOU_V8 = 0xf3;
	uint16_t ENTEI_V8 = 0xf4;
	uint16_t SUICUNE_V8 = 0xf5;
	uint16_t ARTICUNO_V8 = 0x90;
	uint16_t ZAPDOS_V8 = 0x91;
	uint16_t MOLTRES_V8 = 0x92;
	uint16_t MEW_V8 = 0x97;
	uint16_t MEWTWO_V8 = 0x96;
	uint16_t CELEBI_V8 = 0xfb;
	uint16_t SUDOWOODO_V8 = 0xb9;
