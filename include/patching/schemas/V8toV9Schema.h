#ifndef V8_TO_V9_SCHEMA_H
#define V8_TO_V9_SCHEMA_H

#include "core/MigrationSchema.h"
#include <cstddef>

namespace v8toV9Schema {

constexpr int NUM_EVENTS = 0x8ff;
constexpr int NUM_KEY_ITEMS_V9 = 0x26;

// Event flag mappings from save version 8 to save version 9.
// Derived from constants/event_flags.asm in the polishedcrystal repository,
// comparing tags v3.0.0 (save version 8) and v3.1.1 (save version 9).
...
// Key item ID mappings from save version 8 to save version 9.
// Derived from constants/item_constants.asm in the polishedcrystal repository.
...
constexpr MapLocation VALID_PC_WARPS[] = {
...
constexpr size_t NUM_VALID_PC_WARPS = sizeof(VALID_PC_WARPS) / sizeof(VALID_PC_WARPS[0]);

constexpr int PLAINBADGE = 2;
constexpr MapLocation GOLDENROD_POKECOM_CENTER_1F = {11, 24};
constexpr MapLocation PLAYERS_HOUSE_1F = {24, 6};

constexpr WarpValidationConfig WARP_CONFIG = {
	VALID_PC_WARPS,
	NUM_VALID_PC_WARPS,
	PLAINBADGE,
	GOLDENROD_POKECOM_CENTER_1F,
	4,  // badgeFallbackWarpNum
	PLAYERS_HOUSE_1F,
	3   // noBadgeFallbackWarpNum
};

} // namespace v8toV9Schema

#endif // V8_TO_V9_SCHEMA_H
